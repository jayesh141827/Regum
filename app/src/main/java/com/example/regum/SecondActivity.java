...
import com.example.resume_maker.activity_main3;


class Second_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img1.setOnClickListener(view -> {
            ...
            Intent intent = new Intent(Second_Activity.this, activity_main3.class);
        ...
        img2.setOnClickListener(view -> {
            ...
            Intent intent = new Intent(Second_Activity.this, activity_main4.class);
            intent.putExtra("name", name);
            intent.putExtra("birth", birth);
            intent.putExtra("add", add);
            intent.putExtra("mail", mail);
        ...
        img3.setOnClickListener(view -> {
            ...
            Intent intent = new Intent(Second_Activity.this, activity_main5.class);
            intent.putExtra("name", name);
            intent.putExtra("birth", birth);
            intent.putExtra("add", add);
            intent.putExtra("mail", mail);
        ...
        img4.setOnClickListener(view -> {
            ...
            Intent intent = new Intent(Second_Activity.this, activity_main6.class);
            intent.putExtra("name", name);
            intent.putExtra("birth", birth);
            intent.putExtra("add", add);
            intent.putExtra("mail", mail);
